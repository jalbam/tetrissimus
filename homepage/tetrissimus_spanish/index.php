...
<html>
    <head>
        <title>Tetr&iacute;ssimus &copy; (por Joan Alba Maldonado)</title>
                ...
                function iniciar_juego()
                 {
                    ...
                    mostrar_mensaje("Comienza el juego");
...
//                        mostrar_mapa(mapa_matriz, mapa_matriz_anterior);
                ...
                function dar_puntos (numero_lineas)
                 {
                    ...
                    else if (numero_lineas == 2) { puntuacion += 200; mensaje = "Doble"; } //Se han hecho 2 lineas (doble).
                    else if (numero_lineas == 1) { puntuacion += 100; mensaje = "Simple"; } //Se ha hecho 1 linea (simple).
                ...
                function pasar_nivel()
                 {
                    ...
                    mostrar_mensaje("Bienvenido al nivel "+nivel);
                ...
                function actualizar_marcador()
                 {
                    ...
                    document.getElementById("estado").innerHTML = "&nbsp; Nivel: "+nivel+" | Puntos: "+puntuacion;
                ...
                function mostrar_pieza_siguiente(numero_pieza_siguiente)
                 {
                    ...
                    document.getElementById("pieza_siguiente").innerHTML = "Pieza Siguiente: "+pieza_pintada;
                 }
                ...
                function pausar_reanudar_juego()
                 {
                    ...
                    if (!movimiento_pieza) { movimiento_pieza = setInterval("mapa_matriz_anterior = guardar_mapa_anterior; mover_pieza('mantener', parseInt(document.getElementById('pieza').style.top) + desplazamiento); mostrar_mapa(mapa_matriz, mapa_matriz_anterior);", velocidad); mostrar_mensaje("Juego reanudado"); document.getElementById("pausar").innerHTML = "[ Pausar ]"; document.getElementById("pausar").title = "Click aqu&iacute; para pausar el juego"; }
                    //...pero si ya esta moviendose, se pausa:
                    else { clearInterval(movimiento_pieza); movimiento_pieza = false; document.getElementById("mensaje").innerHTML = "Juego pausado"; document.getElementById("mensaje").style.visibility = "visible"; setTimeout('document.getElementById("mensaje").innerHTML = "Juego pausado"; document.getElementById("mensaje").style.visibility = "visible";', 1500); document.getElementById("pausar").innerHTML = "[ Reanudar ]"; document.getElementById("pausar").title = "Click aqu&iacute; para resumir el juego"; }
                 }
    ...
    <body onLoad="javascript:activar_desactivar_mapa_debug('mantener'); iniciar_juego();" onKeyDown="javascript:pulsar_tecla(event, 'onkeypress');" onKeyPress="javascript:pulsar_tecla(event, 'onkeydown');" bgcolor="#eeeeff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <div id="autor" style="background:transparent; color:#aa0000; visibility:visible; top:473px; left:20px; width:244px; height:20px; position:absolute; padding:0px; border:0px; font-size:9px; line-height:15px; font-family:verdana; font-weight:bold; text-align:center; z-index:7;">
            Tetr&iacute;ssimus&copy; por Joan Alba Maldonado
        </div>
        ...
        <div id="opcion_debug" style="visibility:visible; top:470px; left:270px; padding:0px; background:cyan; color:#000066; position:absolute; padding:4px; border:0px; text-align:center; font-weight:bold; font-family:arial; font-size:12px; line-height:20px; z-index:9;">
            <form name="formulario" id="formulario" style="display:inline;">
                <label for="casilla" title="Muestra el mapa en modo debug (texto)" accesskey="m">
                    <input type="checkbox" name="casilla" id="casilla" onClick="javascript:activar_desactivar_mapa_debug('alternar');" checked> <u>M</u>ostrar mapa en modo debug &nbsp;
                </label>
            </form>
        </div>
        <!-- Fin de Mapa en modo debug. -->
        <!-- Boton de Pausa: -->
        <div id="pausar" style="top:450px; left:360px; background:transparent; visibility:visible; color:#660000; position:absolute; padding:4px; border:0px; text-align:center; font-family:arial; font-size:12px; cursor: pointer; cursor: hand; z-index:8;" onClick="javascript:pausar_reanudar_juego();" title="Click aqu&iacute; para pausar el juego">
            [ Pausar ]
        </div>
        ...
        <div style="left:400px; top:10px; height:0px; position:absolute; border:0px; padding:0px; background:transparent; color:#333333; text-align:left; line-height:20px; text-decoration:none; font-family:verdana; font-size:12px; z-index:10;">
            ...
            <br>
            &nbsp;&nbsp;<tt>* Utiliza las flechas del teclado para mover, y la flecha hacia arriba
            <br>
            &nbsp;&nbsp; (tambien la barra espaciadora, el control, el shift o el intro) para rotar
            <br>
            &nbsp;&nbsp; la pieza. En Opera, dejar el puntero del rat&oacute;n encima del area de
            <br>
            &nbsp;&nbsp; juego.</tt>
            <br>
